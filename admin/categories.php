...
if(isset($_GET['del'])){
    ...
    if(isset($_SESSION['username']) and $_SESSION['role'] == 'admin'){
        ...
        if(mysqli_query($con, $del_query)){
            ...
            $del_error = "Category could not be deleted";
        }
    }
}
        ...
        if(mysqli_num_rows($check_run) > 0){
            ...
            if(isset($_SESSION['username']) and $_SESSION['role'] == 'admin'){
                ...
                if(mysqli_query($con, $update_query)){
                    ...
                    $up_error = "Category Could Not Be Updated";
                }
            }
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <ol class="breadcrumb">
                        <li class=""><a href="index.html"><i class="fa fa-tachometer"></i> Dashboard</a></li>
                        ...
                        <div class="col-md-6"><br>
                            ...
                            <table class="table table-hover table-bordered table-striped">
                                ...
                                while($get_row = mysqli_fetch_array($get_run)){
                                    ...
                                    $posts_query = "SELECT * FROM posts WHERE categories LIKE '%$category_name%'";
                                    $posts_run = mysqli_query($con, $posts_query);
                                    if(mysqli_num_rows($posts_run) > 0){
                                        $num_of_posts = mysqli_num_rows($posts_run);
                                    }
                                    else{
                                        $num_of_posts = 0;
                                    }
