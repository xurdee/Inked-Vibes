            ...
            <div class="container-fluid body-section">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <center><img src="img/<?php echo $image;?>" width="200px" height="auto" class="img-thumbnail" alt="Failed to Load" id="profile-image"></center><br>
                                ...
                                <a href="edit-profile.php?edit=<?php echo $id;?>" class="btn btn-primary">Edit Profile</a>
